pipeline{
    ...
    parameters {
        ...
        string defaultValue: 'awscust.yml', description: 'enter managed file name', name: 'vars_name', trim: true
    }
    ...
    stages{
        ...
        stage('AWS'){
            ...
            steps{
                ...
                configFileProvider([configFile(fileId: '${params.vars_name}', targetLocation: 'group_vars/awscust.yml')]) {
                }
